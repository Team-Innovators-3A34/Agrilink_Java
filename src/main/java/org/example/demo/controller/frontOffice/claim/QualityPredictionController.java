...
public class QualityPredictionController {
    ...
    /**
     * Envoie l'image sélectionnée à l'API de prédiction pour obtenir la qualité.
     */
    @FXML
    private void handleSubmit(ActionEvent event) {
        ...
        resultArea.setText("Analyse de la qualité en cours...");
        ...
        new Thread(() -> {
            try {
                ...
                writer.append("Content-Disposition: form-data; name=\"file\"; filename=\"" + selectedImage.getName() + "\"")
                        .append("\r\n");
                ...
                String prediction = jsonResponse.has("model2_prediction")
                        ? jsonResponse.get("model2_prediction").getAsString()
                        : "Aucune prédiction";
