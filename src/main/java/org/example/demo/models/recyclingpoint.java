...
public class recyclingpoint {
    ...
    public recyclingpoint(int id, String nom, String adresse, double longitude, double latitude, String date, String type,  String image, String description,int owner_id) {
        this.id = id;
        this.nom = nom;
        this.adresse = adresse;
        this.longitude = longitude;
