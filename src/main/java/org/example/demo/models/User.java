...
public class User {
    ...
    public User(int id ,String email, String nom, String prenom, String adresse, String roles, String telephone, String accountVerification, String image,int score ,String description,float latitude,float longitude) {
        this.email = email;
        this.nom = nom;
        this.prenom = prenom;
        this.adresse = adresse;
